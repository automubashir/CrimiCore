...
import { CRIMINAL_STATS } from '@/lib/data/criminals'
import styles from './ThreatDistribution.module.css'

const PIE_DATA = [
  { label: 'High Threat',   pct: 9,  count: CRIMINAL_STATS.high,   color: '#F2464A' },
  { label: 'Medium Threat', pct: 28, count: CRIMINAL_STATS.medium, color: '#F3921B' },
  { label: 'Low Threat',    pct: 63, count: CRIMINAL_STATS.low,    color: '#70EA8D' },
]
        ...
        <div className={styles.body}>
          <div className={styles.chartWrap}>
            ...
            <div className={styles.centerLabel} aria-hidden="true">
              <span className={styles.centerNum}>{CRIMINAL_STATS.total}</span>
